...
ElasticSearchClient.prototype.suggest = function(indexName, queryObj, options, cb) {
    //Pull the callback and set it false to not clobber id.
    if(typeof arguments[arguments.length-1]=='function'){
        cb=arguments[arguments.length-1];
        arguments[arguments.length-1]=false;
    ...
    return this.createCall({path: path, method: 'POST',data: JSON.stringify(queryObj)}, this.clientOptions, cb);
}
